...
function Footer() {
    return (
        <div className="flex gap-5 w-full h-screen bg-zinc-900 p-10 font-['Founders_Grotesk_X_Condensed']">
            <div className="flex flex-col justify-between w-1/2 h-full">
                <div className="headings mt-24">
            ...
            <div className="w-1/2">
                <div className="heading mt-2">
                    <h1 className="text-[6vw] font-semibold    uppercase leading-none mt-24">Presentations</h1>
                <div className="links font-['Neue_Montreal']">
                    <a className="block underline text-xl leading-10 tracking-wide" href="#">Instagram</a>
                    <a className="block underline text-xl leading-10 tracking-wide" href="#">Behance</a>
                    <a className="block underline text-xl leading-10 tracking-wide" href="#">Facebook</a>
                    <a className="block underline text-xl leading-10 tracking-wide" href="#">Linkedin</a>
                </div>
                </div>
                </div>
        </div>
